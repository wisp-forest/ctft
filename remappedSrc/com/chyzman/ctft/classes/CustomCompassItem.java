...
public class CustomCompassItem extends Item implements Vanishable {
    ...
    public CustomCompassItem(Item.Properties p_40718_) {
        super(p_40718_);
    }
        ...
        if (!level.getBlockState(blockpos).is(Blocks.LODESTONE)) {
            ...
            if (flag) {
                ...
                if (itemstack.hasTag()) {
                    ...
                    compoundtag = itemstack.getTag().copy();
                } else {
    ...
    public String getDescriptionId(@Nonnull ItemStack pStack) {
        return isLodestoneCompass(pStack) ? Util.makeDescriptionId("item", ResourceLocation.tryParse(this.getRegistryName() + "_lodestone")) : super.getDescriptionId();
    }
}
