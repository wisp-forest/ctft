    ...
    public void onInitializeClient() {
        ...
        Registry.ITEM.forEach(item -> {
            if (item instanceof CustomBowItem customBowItem) {
                FabricModelPredicateProviderRegistry.register(customBowItem, new Identifier("pull"), (stack, world, entity, seed) -> {
                    if (entity == null) {
                        return 0.0f;
                    }
            ...
            if (item instanceof CustomCrossbowItem customCrossbowItem) {
                FabricModelPredicateProviderRegistry.register(customCrossbowItem, new Identifier("pull"), (stack, world, entity, seed) -> {
                    if (entity == null) {
                        return 0.0f;
                    }
                    if (CustomCrossbowItem.isCharged(stack)) {
                        return 0.0f;
                    }
                    return (float) (stack.getMaxUseTime() - entity.getItemUseTimeLeft()) / (float) CustomCrossbowItem.getPullTime(stack);
                });
            ...
            if (item instanceof CustomFishingRodItem customFishingRodItem) {
                FabricModelPredicateProviderRegistry.register(customFishingRodItem, new Identifier("cast"), (stack, world, entity, seed) -> {
                    boolean bl2;
                    if (entity == null) {
                        return 0.0f;
                    }
