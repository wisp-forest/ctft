...
public final class CtftRecipeSerializers {
    public static RecipeSerializer<CtftRecipe> CTFT_SHAPED = Registry.register(Registries.RECIPE_SERIALIZER, id("crafting_shaped"), new CtftRecipe.Serializer());
    ...
    public static final SpecialRecipeSerializer<CtftShearsRecipe> CTFT_SHEARS_RECIPE = new SpecialRecipeSerializer<>(CtftShearsRecipe::new);
    ...
    public static void Init() {
        ...
        Registry.register(Registries.RECIPE_SERIALIZER, id("shears"), CTFT_SHEARS_RECIPE);
    }
}