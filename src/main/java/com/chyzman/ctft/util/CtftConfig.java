...
import com.chyzman.ctft.CtftItemType;
...
public class CtftConfig implements ConfigData {
    ...
    @SerializedName("enabled_item_types")
    public Map<String, Boolean> enabledItemTypes = new HashMap<>();
...
//    public ToggleTools tools_config = new ToggleTools();
    ...
    public CtftConfig() {
        for (var type : CtftItemType.values()) {
            enabledItemTypes.put(type.id, false);
        }
    }
